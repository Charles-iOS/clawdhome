// EZRWorkerHelper/Operations/LocalLLMManager.swift
...
struct LocalLLMManager {
    static let label      = "ai.ezrworker.omlx"
    static let port       = 18800
    static let plistPath  = "/Library/LaunchDaemons/ai.ezrworker.omlx.plist"
    static let modelDir   = "/Users/Shared/EZRWorkerApp/models/omlx"
    ...
    private static func ensureModelDir() {
        ...
        _ = try? run("/bin/chmod", args: ["755", "/Users/Shared/EZRWorker"])
    ...
    private static func makePlist(binary: String, adminUsername: String) -> String {
        ...
        <dict>
            ...
            <string>/tmp/ezrworker-omlx.log</string>
