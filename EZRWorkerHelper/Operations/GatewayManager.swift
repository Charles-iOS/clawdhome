// EZRWorkerHelper/Operations/GatewayManager.swift
...
struct GatewayManager {
    private static let gatewayLabel = "ai.ezrworker.gateway"
    ...
    static func startGateway(username: String, uid: Int) throws {
        ...
        do {
            ...
            // 允许 EZRWorker（本地 Control UI）以 token auth 连接而无需 device identity
