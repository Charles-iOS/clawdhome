...
struct ClawdHomeApp: App {
    ...
    @State private var brandMigrationManager: BrandMigrationManager
    ...
    init() {
        ...
        let brandMigrationManager = BrandMigrationManager()
        let profileStore = GatewayProfileStore(migrationManager: brandMigrationManager)
        ...
        _brandMigrationManager = State(initialValue: brandMigrationManager)
