...
This project uses a single String Catalog file: `EZRWorkerApp/Stable.xcstrings`.
...
1. Add or update stable keys in `EZRWorkerApp/Stable.xcstrings`.
...
1. Add the language localization block for each key in `EZRWorkerApp/Stable.xcstrings`.
