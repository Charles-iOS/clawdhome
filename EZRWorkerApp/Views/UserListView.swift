// EZRWorkerApp/Views/UserListView.swift
...
private struct ClawCard: View {
    ...
    var body: some View {
        ...
        .help(L10n.k("views.user_list_view.filefolder_openclaw_ezrworker_upload", fallback: "可将文件或文件夹拖入该虾卡片，快传到 ~/.openclaw/ezrworker_upload"))
    }
