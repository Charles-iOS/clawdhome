// EZRWorkerApp/Views/UpgradeConfirmSheet.swift
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    if autoBackup {
                        Text(L10n.k("auto.upgrade_confirm_sheet.documents_ezrworker_backups_savebackup_upgraderollback", fallback: "将在 ~/Documents/EZRWorker Backups/ 保存一份备份，升级后可一键回退。"))
                            .font(.caption)
